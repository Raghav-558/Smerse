    ...
    <div className="max-w-[1176px] px-4 mx-auto flex items-center justify-between">
      <a href="/">
        <Image
          ...
          width={68}
          height={68}
          className="pointer-events-none sixe-[68px] max-md:size-10"
        />
      </a>
      <div
        className={`flex gap-[59px] max-lg:gap-10 max-md:gap-5 max-lg:fixed max-lg:top-0 max-lg:-right-full max-lg:h-full max-lg:w-full max-lg:justify-center max-lg:items-center transition-all duration-300 max-lg:flex-col max-lg:bg-blue-400 max-lg:z-20 ${
          open ? "max-lg:!right-0" : ""
        }`}
      >
